...
const RARITY_WEIGHTS = { Energy: 0, Common: 1, Rare: 2, Epic: 3, Legendary: 4 };
...
const COMBAT_CHARACTERS = [
  // Commons
  { id: 'c1', name: 'Water Bubble', rarity: 'Common', element: 'Water', hp: 40, attack: 'Splash', dmg: 10, ability: 'Cleanse: Removes burn effects.', flavor: 'A cheerful droplet of sentient water.', imgSrc: 'https://api.dicebear.com/9.x/fun-emoji/svg?seed=slime' },
  { id: 'c2', name: 'Desert Nomad', rarity: 'Common', element: 'Earth', hp: 50, attack: 'Sand Throw', dmg: 20, ability: 'Scavenge: Finds 5 coins if it survives.', flavor: 'Wanders the endless dunes seeking treasure.', imgSrc: 'https://api.dicebear.com/9.x/adventurer/svg?seed=goblin' },
  { id: 'c3', name: 'Aero Prism', rarity: 'Common', element: 'Wind', hp: 30, attack: 'Sharp Gust', dmg: 15, ability: 'Evade: 10% chance to dodge attacks.', flavor: 'A floating crystal powered by the wind.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=wisp' },
  { id: 'c4', name: 'Scrap Drone', rarity: 'Common', element: 'Steel', hp: 70, attack: 'Wrench Toss', dmg: 20, ability: 'Plating: Reduces incoming damage by 5.', flavor: 'An outdated bot that still packs a punch.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=rusty' },
  { id: 'c5', name: 'Mud Sludge', rarity: 'Common', element: 'Earth', hp: 50, attack: 'Splat', dmg: 15, ability: 'Sticky: Lowers enemy speed.', flavor: 'A sentient puddle of thick mud.', imgSrc: 'https://api.dicebear.com/9.x/fun-emoji/svg?seed=mud' },
  { id: 'c6', name: 'Static Spark', rarity: 'Common', element: 'Electric', hp: 30, attack: 'Jolt', dmg: 25, ability: 'Shock: May stun enemy for 1 turn.', flavor: 'A tiny burst of rogue energy.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=spark' },
  { id: 'c7', name: 'Ember Pup', rarity: 'Common', element: 'Fire', hp: 40, attack: 'Nip', dmg: 15, ability: 'Warmth: Heals adjacent allies by 5 HP.', flavor: 'Playful, but slightly too hot to pet.', imgSrc: 'https://api.dicebear.com/9.x/fun-emoji/svg?seed=pup' },
  { id: 'c8', name: 'Dew Drop', rarity: 'Common', element: 'Water', hp: 30, attack: 'Drip', dmg: 10, ability: 'Refresh: Restores 10 HP to self.', flavor: 'Reflects the morning light beautifully.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=dew' },
  { id: 'c9', name: 'Shadow Imp', rarity: 'Common', element: 'Dark', hp: 45, attack: 'Scratch', dmg: 20, ability: 'Stealth: Cannot be targeted first turn.', flavor: 'Lurks just outside your peripheral vision.', imgSrc: 'https://api.dicebear.com/9.x/adventurer/svg?seed=imp' },
  { id: 'c10', name: 'Scout Bot', rarity: 'Common', element: 'Steel', hp: 60, attack: 'Scan', dmg: 15, ability: 'Reveal: Exposes enemy traps.', flavor: 'Beeps reassuringly while surveying.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=scout' },
  { id: 'c11', name: 'Breeze Sprite', rarity: 'Common', element: 'Wind', hp: 35, attack: 'Puff', dmg: 10, ability: 'Tailwind: +10 Speed to team.', flavor: 'Guides lost travelers to safety.', imgSrc: 'https://api.dicebear.com/9.x/lorelei/svg?seed=breeze' },
  { id: 'c12', name: 'Sun Mote', rarity: 'Common', element: 'Light', hp: 40, attack: 'Flash', dmg: 15, ability: 'Blind: Lowers enemy accuracy.', flavor: 'A concentrated beam of pure daylight.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=sun' },
  { id: 'c13', name: 'Stardust', rarity: 'Common', element: 'Cosmic', hp: 30, attack: 'Twinkle', dmg: 20, ability: 'Wish: Draw an extra card next turn.', flavor: 'Fell from a comet thousands of years ago.', imgSrc: 'https://api.dicebear.com/9.x/fun-emoji/svg?seed=dust' },
  { id: 'c14', name: 'Pebble Pet', rarity: 'Common', element: 'Earth', hp: 70, attack: 'Roll', dmg: 10, ability: 'Hard Head: Immune to critical hits.', flavor: 'The lowest maintenance pet imaginable.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=pebble' },
  
  // Rares
  { id: 'r1', name: 'Pyromancer', rarity: 'Rare', element: 'Fire', hp: 80, attack: 'Fireball', dmg: 40, ability: 'Ignite: Deals 10 burn damage for 2 turns.', flavor: 'A mage obsessed with the dancing flames.', imgSrc: 'https://api.dicebear.com/9.x/adventurer/svg?seed=flame' },
  { id: 'r2', name: 'Phantom Maiden', rarity: 'Rare', element: 'Ghost', hp: 70, attack: 'Eerie Chill', dmg: 45, ability: 'Intimidate: Lowers enemy attack by 10.', flavor: 'A lingering spirit from a forgotten era.', imgSrc: 'https://api.dicebear.com/9.x/lorelei/svg?seed=aqua' },
  { id: 'r3', name: 'Voltage Mech', rarity: 'Rare', element: 'Electric', hp: 120, attack: 'Spark Plug', dmg: 30, ability: 'Overload: Double damage if below 30 HP.', flavor: 'A high-powered automaton running on raw electricity.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=golem' },
  { id: 'r4', name: 'Zephyr Fairy', rarity: 'Rare', element: 'Wind', hp: 60, attack: 'Tornado Sweep', dmg: 50, ability: 'Gale Force: Switches out the enemy active card.', flavor: 'Dances inside hurricanes for fun.', imgSrc: 'https://api.dicebear.com/9.x/lorelei/svg?seed=sprite' },
  { id: 'r5', name: 'Aqua Knight', rarity: 'Rare', element: 'Water', hp: 90, attack: 'Wave Slash', dmg: 40, ability: 'Tide Shield: Blocks the next 20 damage.', flavor: 'Defends the sunken kingdoms with honor.', imgSrc: 'https://api.dicebear.com/9.x/adventurer/svg?seed=aquaknight' },
  { id: 'r6', name: 'Inferno Bot', rarity: 'Rare', element: 'Fire', hp: 100, attack: 'Heat Ray', dmg: 50, ability: 'Meltdown: Deals 30 damage to self and enemy on death.', flavor: 'Overheats frequently, but deals massive damage.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=inferno' },
  { id: 'r7', name: 'Gale Glider', rarity: 'Rare', element: 'Wind', hp: 75, attack: 'Dive', dmg: 45, ability: 'First Strike: Always attacks first.', flavor: 'Never touches the ground if it can help it.', imgSrc: 'https://api.dicebear.com/9.x/lorelei/svg?seed=glider' },
  { id: 'r8', name: 'Lunar Owl', rarity: 'Rare', element: 'Cosmic', hp: 80, attack: 'Moonbeam', dmg: 55, ability: 'Foresight: Look at the top card of your deck.', flavor: 'Its hoot can be heard across the vacuum of space.', imgSrc: 'https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=owl' },
  { id: 'r9', name: 'Terra Golem', rarity: 'Rare', element: 'Earth', hp: 140, attack: 'Quake', dmg: 35, ability: 'Tremor: Deals 10 damage to benched enemies.', flavor: 'A moving mountain of raw strength.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=terra' },
  { id: 'r10', name: 'Plasma Core', rarity: 'Rare', element: 'Electric', hp: 90, attack: 'Shockwave', dmg: 60, ability: 'Chain Lightning: Hits a second enemy for half damage.', flavor: 'An unstable reactor just waiting to burst.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=plasma' },
  
  // Epics
  { id: 'e1', name: 'Shadow Automaton', rarity: 'Epic', element: 'Dark', hp: 100, attack: 'Dark Beam', dmg: 80, ability: 'Siphon: Heals for 50% of damage dealt.', flavor: 'Constructed from forbidden, abyssal technology.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=void' },
  { id: 'e2', name: 'Dawn Paladin', rarity: 'Epic', element: 'Light', hp: 130, attack: 'Radiant Slash', dmg: 70, ability: 'Aura of Light: Allies take 10 less damage.', flavor: 'Draws power directly from the midday sun.', imgSrc: 'https://api.dicebear.com/9.x/adventurer-neutral/svg?seed=solar' },
  { id: 'e3', name: 'Iron Blademaster', rarity: 'Epic', element: 'Steel', hp: 90, attack: 'Omni-Slash', dmg: 90, ability: 'Pierce: Ignores enemy armor and shields.', flavor: 'Has mastered every weapon known to mankind.', imgSrc: 'https://api.dicebear.com/9.x/adventurer/svg?seed=blade' },
  { id: 'e4', name: 'Storm Bringer', rarity: 'Epic', element: 'Wind', hp: 110, attack: 'Hurricane', dmg: 85, ability: 'Cyclone: Shuffles enemy hand.', flavor: 'Summons storms with a flick of the wrist.', imgSrc: 'https://api.dicebear.com/9.x/adventurer/svg?seed=storm' },
  { id: 'e5', name: 'Abyssal Horror', rarity: 'Epic', element: 'Dark', hp: 140, attack: 'Void Crush', dmg: 95, ability: 'Terror: Enemies cannot heal while this is active.', flavor: 'Do not look into its eyes. Just don\'t.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=horror' },
  { id: 'e6', name: 'Luminous Seraph', rarity: 'Epic', element: 'Light', hp: 120, attack: 'Holy Strike', dmg: 80, ability: 'Resurrect: Revives the first fainted ally with 30 HP.', flavor: 'Descends from the heavens to smite evil.', imgSrc: 'https://api.dicebear.com/9.x/lorelei/svg?seed=seraph' },
  
  // Legendaries
  { id: 'l1', name: 'Nebula Construct', rarity: 'Legendary', element: 'Cosmic', hp: 180, attack: 'Supernova', dmg: 150, ability: 'Big Bang: Destroys all shields and buffs on the field.', flavor: 'An abstract entity born from a dying star.', imgSrc: 'https://api.dicebear.com/9.x/shapes/svg?seed=dragon' },
  { id: 'l2', name: 'Astral Weaver', rarity: 'Legendary', element: 'Light', hp: 150, attack: 'Solar Flare', dmg: 140, ability: 'Reality Warp: Swap HP percentage with enemy once per game.', flavor: 'Spins new galaxies from stardust.', imgSrc: 'https://api.dicebear.com/9.x/lorelei-neutral/svg?seed=star' },
  { id: 'l3', name: 'Titan of the Deep', rarity: 'Legendary', element: 'Water', hp: 200, attack: 'Tsunami', dmg: 160, ability: 'Flood: Washes away all bench cards, forcing a reset.', flavor: 'Sleeps at the bottom of the Mariana Trench.', imgSrc: 'https://api.dicebear.com/9.x/bottts/svg?seed=titan' },
];
...
const PACKS = [
  {
    id: 'p1', name: 'Genesis Premium Pack', description: '8 Cards. Guarantees 1 Energy, 1 Epic & 1 Rare.',
    cost: 500, cardCount: 8, color: 'from-amber-600 via-yellow-700 to-amber-900',
    dropRates: { Common: 0.50, Rare: 0.35, Epic: 0.12, Legendary: 0.03 },
...
const openPack = (pack) => {
  ...
  pack.guaranteed.forEach(rarity => {
    const possible = COMBAT_CHARACTERS.filter(c => c.rarity === rarity);
  ...
  for (let i = 0; i < remaining; i++) {
    ...
    const possible = COMBAT_CHARACTERS.filter(c => c.rarity === rolledRarity);
    pulled.push({ ...possible[Math.floor(Math.random() * possible.length)], instanceId: Math.random().toString(36).substr(2, 9) });
  }
  return pulled.sort((a, b) => RARITY_WEIGHTS[a.rarity] - RARITY_WEIGHTS[b.rarity]);
};
  ...
  return (
    <div className={`relative cursor-pointer group perspective-1000 ${dims} ${selectionRing}`} onClick={onClick} style={{ perspective: '1000px' }}>
      <div className={`w-full h-full absolute transition-transform duration-500 preserve-3d shadow-xl rounded-2xl ${!isFlipped ? 'rotate-y-180' : ''}`} style={{ transformStyle: 'preserve-3d', transform: !isFlipped ? 'rotateY(180deg)' : 'rotateY(0deg)' }}>
        ...
        {/* Front */}
        <div className={`absolute w-full h-full backface-hidden rounded-2xl ${rarityStyle.outerBg} p-1 sm:p-1.5 ${size === 'large' ? 'shadow-[0_0_40px_rgba(0,0,0,0.6)]' : ''}`} style={{ backfaceVisibility: 'hidden' }}>
          <div className={`relative w-full h-full rounded-xl bg-gradient-to-br ${rarityStyle.bg} flex flex-col overflow-hidden border-2 sm:border-4 ${rarityStyle.border}`}>
            ...
            <div className={`flex justify-between items-center ${padding} bg-white/50 backdrop-blur-sm border-b-2 ${rarityStyle.border}`}>
              <h3 className={`font-black uppercase tracking-tighter text-black ${size === 'large' ? 'text-2xl sm:text-3xl' : size === 'small' ? 'text-[0.6rem] sm:text-[0.8rem]' : 'text-[0.4rem] sm:text-[0.5rem]'} truncate max-w-[70%]`}>{card.name}</h3>
...
const BattleArena = ({ playerDeckIds, onWin, onLose, onExit }) => {
  ...
  const [log, setLog] = useState(["Battle started! Draw 7 cards."]);

  // Players State
  const [player, setPlayer] = useState({ deck: [], hand: [], bench: [], active: null, prizes: 3, energyAttachedThisTurn: false, hasDrawnThisTurn: false });
  const [bot, setBot] = useState({ deck: [], hand: [], bench: [], active: null, prizes: 3 });
  ...
  useEffect(() => {
    ...
    // Create detailed card objects for battle instances
    ...
    let pDeck = createBattleDeck(playerDeckIds);
    // Create random bot deck (20 combat, 10 energy)
    let bDeckIds = [];
    ...
    let bDeck = createBattleDeck(bDeckIds);

    // Initial Draw 7
    setPlayer({ deck: pDeck.slice(7), hand: pDeck.slice(0, 7), bench: [], active: null, prizes: 3, energyAttachedThisTurn: false, hasDrawnThisTurn: false });
    setBot({ deck: bDeck.slice(7), hand: bDeck.slice(0, 7), bench: [], active: null, prizes: 3 });

    addToLog("Setup phase: Choose a Basic Character to be your Active.");
  }, [playerDeckIds]);
      ...
      const executeBotTurn = async () => {
        ...
        if (currentBot.active && currentPlayer.active && currentBot.active.attachedEnergy > 0) {
           ...
           if (currentPlayer.active.currentHp <= 0) {
              addToLog(`Player's ${currentPlayer.active.name} fainted! Bot took a Prize Card.`);
              currentBot.prizes -= 1;
  ...
  const handleAttack = () => {
    ...
    if (currentBot.active.currentHp <= 0) {
       addToLog(`Bot's ${currentBot.active.name} fainted! You took a Prize Card.`);
       currentBot.active = null;
       setPlayer(p => ({ ...p, prizes: p.prizes - 1 }));
       
       if (player.prizes - 1 <= 0) {
          setBot(currentBot);
          setWinner('player');
          setGameState('gameOver');
          return;
  ...
  useEffect(() => {
    if (gameState === 'setup' && !bot.active && bot.hand.length > 0) {
       ...
       if (combatCards.length > 0) {
          ...
          setBot(currentBot);
          if (player.active) setGameState('playerTurn');
       }
    }
  }, [bot, gameState, player.active]);
    ...
    <div className="flex-1 flex flex-col bg-stone-900 border-4 border-stone-800 rounded-[2rem] overflow-hidden shadow-2xl max-h-[85vh]">
      ...
      <div className="h-1/3 bg-stone-950/80 border-b border-stone-800 p-4 flex flex-col relative">
         ...
         <div className="absolute top-4 left-4 flex gap-2">
            {[...Array(bot.prizes)].map((_, i) => <div key={i} className="w-8 h-12 bg-amber-600/50 border border-amber-500 rounded shadow-md backface-hidden" style={{ transform: 'rotateY(180deg)' }}></div>)}
         </div>
      ...
      <div className="h-16 bg-stone-800 flex justify-between items-center px-6 border-y-2 border-stone-950 shadow-inner z-10">
         ...
         <div className="flex space-x-2">
           <button onClick={handleDraw} disabled={gameState !== 'playerTurn' || player.hasDrawnThisTurn} className="px-6 py-1.5 bg-blue-600 disabled:bg-stone-700 text-white font-black rounded-lg shadow-md hover:bg-blue-500 transition-colors flex items-center gap-2">
              <Layers className="w-4 h-4" /> DRAW
           </button>
           <button onClick={handleAttack} disabled={gameState !== 'playerTurn' || !player.active || player.active.attachedEnergy < 1 || !player.hasDrawnThisTurn} className="px-6 py-1.5 bg-rose-600 disabled:bg-stone-700 text-white font-black rounded-lg shadow-md hover:bg-rose-500 transition-colors flex items-center gap-2">
              <Swords className="w-4 h-4" /> ATTACK
           </button>
           <button onClick={passTurn} disabled={gameState !== 'playerTurn' || !player.hasDrawnThisTurn} className="px-6 py-1.5 bg-stone-600 disabled:bg-stone-700 text-white font-bold rounded-lg hover:bg-stone-500 transition-colors">
              PASS
           </button>
         </div>
      </div>
      ...
      <div className="h-1/2 bg-stone-900 p-4 flex flex-col justify-between relative">
         ...
         <div className="absolute bottom-4 right-4 flex gap-2">
            {[...Array(player.prizes)].map((_, i) => <div key={i} className="w-8 h-12 bg-amber-600 border border-amber-400 rounded shadow-[0_0_10px_rgba(245,158,11,0.5)]"></div>)}
            <span className="text-amber-500 font-bold text-xs uppercase ml-2 mt-4">Prizes</span>
         </div>
        ...
        {activeTab === 'shop' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 flex-1 flex flex-col items-center justify-center pb-10">
            <div className="text-center mb-10 sm:mb-14">
              <h2 className="text-4xl sm:text-6xl font-black text-white mb-4 sm:mb-6 tracking-tighter drop-shadow-2xl">SET 1: GENESIS</h2>
            ...
            <div className="grid grid-cols-1 max-w-lg w-full gap-8 px-4">
              {PACKS.map(pack => (
                <div key={pack.id} className="group relative bg-stone-900/80 backdrop-blur-md border border-stone-700/50 rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl hover:border-amber-500/50 transition-all hover:-translate-y-3 duration-300">
                  <div className={`h-48 sm:h-56 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] ${pack.color} flex items-center justify-center p-6 sm:p-8 text-center relative overflow-hidden`}>
                     ...
                     <h3 className="text-3xl sm:text-4xl font-black text-white tracking-[0.2em] shadow-black drop-shadow-[0_6px_6px_rgba(0,0,0,0.8)] z-10 flex flex-col items-center">
                        <Layers className="w-12 h-12 sm:w-16 sm:h-16 mb-4 text-amber-300 drop-shadow-xl" />
                        {pack.name}
                     </h3>
                  </div>
